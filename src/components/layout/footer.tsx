        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/shipping" className="text-muted-foreground hover:text-primary">Shipping Policy</Link></li>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Fast, reliable shopping with a seamless experience. Your one-stop shop for all your needs.
            </p>
            <div className="space-x-4">
              <a href="#" className="text-muted-foreground hover:text-primary">
                <span className="sr-only">Facebook</span>
                <svg className="h-5 w-5 inline-block" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
